    ...
    function initResultPage() {
      ...
      function renderResult(payloadRaw) {
        ...
        questions.forEach(function (q, idx) {
          ...
          var yourAnsRaw    = q.selected_text || q.your_answer || q.student_answer || q.student_answers || q.given_answers || "";
          var correctAnsRaw = q.correct_text || q.correct_answer || q.correct_answers || "";
